...
Item {
    ...
    Item{
        ...
        property bool isCompactAndNotPanel:d.displayMode === FluNavigationViewType.Compact && !d.enableNavigationPanel && !d.isHovered
    ...
    Rectangle{
        ...
        HoverHandler {
                    onHoveredChanged: {
                        // 只有在 Compact 模式下我们才关心悬停展开
                        // 如果本来就是 Open 模式，hovered 变化也不影响
                        d.isHovered = hovered
                    }
                }
        FluShadow{
